...
<body>
	<div>
		...
		<div class="nav-bar">
			...
			<ul class="sub-menu">
				...
				<li>
					<a class="catalogue" href="components/brands/rooms/kitchen.html"><i class="icon-navbar fa fa-utensils"></i>Phòng bếp</a>
				</li>
				<li>
				...
				<li class="brand-dropdown-1">
					...
					<ul class="drop-menu-1">
						...
						<li><a href="#">Liên hệ với cúng tôi</a></li>
					</ul>
				</li>						
			</ul>			
		</div>					
	...
	<div class="parallax bg1">
		...
		<div class="text-banner">Liên hệ với chúng tôi</div>
	</div>
	<div class="container" style="padding-bottom: 50px;">
		...
		<div class="row">
			<div class="col-xl-6 col-sm-12 text-about">
				<p>
                    Tìm kiếm thêm thông tin về các sản phẩm của chúng tôi? Chia sẻ thông tin bạn cần cho chúng tôi, chúng tôi muốn nghe từ bạn! Hãy cho chúng tôi biết tất cả về căn phòng của bạn.
				...
				<ul class="address">
					...
					<li>
						...
						<a href="mailto:duongmanhduy.sla@gmail.com">duongmanhduy.sla@gmail.com</a>
					</li>
					<li>
						<span style="font-weight: bold; font-size: 13px;">SĐT: </span>
						<a href="tel:0123456789">0123456789</a>
					</li>
				</ul>
			</div>
			<div class="col-xl-6 col-sm-12" style="padding: 0;">
				...
				<div class="col-xl-3 col-sm-6">
					<div class="footer-content">
						...
						<ul>
							...
							<li><a href="components/brands/rooms/bathroom.html" style="color: #6b6b6b; ">Phòng tăm</a></li>
						</ul>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6">
